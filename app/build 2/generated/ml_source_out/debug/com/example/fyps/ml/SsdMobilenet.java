 ...
 */
public final class SsdMobilenet {
  @NonNull
  ...
  private SsdMobilenet(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "ssd_mobilenet.tflite", options);
  ...
  @NonNull
  public static SsdMobilenet newInstance(@NonNull Context context) throws IOException {
    return new SsdMobilenet(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SsdMobilenet newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new SsdMobilenet(context, options);
  }
