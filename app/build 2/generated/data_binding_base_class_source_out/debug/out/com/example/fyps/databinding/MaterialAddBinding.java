...
public final class MaterialAddBinding implements ViewBinding {
  @NonNull
  ...
  private MaterialAddBinding(@NonNull ScrollView rootView, @NonNull Button buttonOpenCamera,
  ...
  @NonNull
  public static MaterialAddBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MaterialAddBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.material_add, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MaterialAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MaterialAddBinding((ScrollView) rootView, buttonOpenCamera, buttonSelectImage,
          buttonSubmit, createItemTitle, editTextDateTime, editTextItemDescription,
          editTextItemName, editTextItemVenue, imageViewCourseBanner, layoutDateTime, layoutDesc,
          layoutItemCategory, layoutName, layoutVenue, linearLayout5, locationLayout, mapView,
          spinnerItemCategory);
    }
