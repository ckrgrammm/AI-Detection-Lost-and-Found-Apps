...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imageView,
      @NonNull RelativeLayout relativeLayoutBackground, @NonNull TextView textViewName) {
    this.rootView = rootView;
    this.imageView = imageView;
    this.relativeLayoutBackground = relativeLayoutBackground;
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RelativeLayout relativeLayoutBackground = (RelativeLayout) rootView;
      ...
      return new ItemNewsBinding((RelativeLayout) rootView, imageView, relativeLayoutBackground,
          textViewName);
    }
