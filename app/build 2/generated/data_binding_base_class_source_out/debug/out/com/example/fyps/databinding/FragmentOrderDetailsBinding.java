...
public final class FragmentOrderDetailsBinding implements ViewBinding {
  ...
  private FragmentOrderDetailsBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull RecyclerView recyQuestion, @NonNull Toolbar toolbarAllOrderDetails,
      @NonNull TextView tvOrderId, @NonNull TextView tvProducts,
      @NonNull TextView tvShoppingAddresses) {
  ...
  public static FragmentOrderDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.recyQuestion;
      RecyclerView recyQuestion = ViewBindings.findChildViewById(rootView, id);
      if (recyQuestion == null) {
        break missingId;
      }
      ...
      return new FragmentOrderDetailsBinding((NestedScrollView) rootView, btnChat, guideline1,
          ...
          ratingBtn, recyQuestion, toolbarAllOrderDetails, tvOrderId, tvProducts,
          tvShoppingAddresses);
    }
