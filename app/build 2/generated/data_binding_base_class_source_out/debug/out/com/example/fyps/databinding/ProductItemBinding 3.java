...
public final class ProductItemBinding implements ViewBinding {
  ...
  private ProductItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgFavorite,
  ...
  public static ProductItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProductItemBinding((LinearLayout) rootView, imgFavorite, imgProduct,
