...
public class FragmentQuestionBindingImpl extends FragmentQuestionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recyQuestion, 5);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.questionViewModel == variableId) {
            setQuestionViewModel((com.example.fyps.viewmodel.quiz.QuestionViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setQuestionViewModel(@Nullable com.example.fyps.viewmodel.quiz.QuestionViewModel QuestionViewModel) {
