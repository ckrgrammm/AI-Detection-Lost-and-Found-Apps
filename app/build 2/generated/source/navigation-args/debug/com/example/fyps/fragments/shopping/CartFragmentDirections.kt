...
public class CartFragmentDirections private constructor() {
  private data class ActionCartFragmentToBillingFragment(
    public val clickFlag: String,
    public val price: String? = "null",
    public val products: CartProductsList? = null
  ) : NavDirections {
    public override val actionId: Int = R.id.action_cartFragment_to_billingFragment
  ...
  public companion object {
    public fun actionCartFragmentToBillingFragment(
      clickFlag: String,
      price: String? = "null",
      products: CartProductsList? = null
    ): NavDirections = ActionCartFragmentToBillingFragment(clickFlag, price, products)
  }
}
