...
public class ResultFragmentDirections private constructor() {
  private data class ActionResultFragmentToQuizFragment(
    public val materialDocId: String?
  ) : NavDirections {
    public override val actionId: Int = R.id.action_resultFragment_to_quizFragment
  ...
  private data class ActionResultFragmentToOrderDetails(
    public val material: Material,
    public val courseDocument: CourseDocument
  ) : NavDirections {
    public override val actionId: Int = R.id.action_resultFragment_to_orderDetails
  ...
  public companion object {
    public fun actionResultFragmentToQuizFragment(materialDocId: String?): NavDirections =
        ActionResultFragmentToQuizFragment(materialDocId)

    public fun actionResultFragmentToOrderDetails(material: Material,
        courseDocument: CourseDocument): NavDirections =
        ActionResultFragmentToOrderDetails(material, courseDocument)
  }
}
