...
public class objectDetectorClass {
    ...
    private String mostConfidentDetectedObjectName = "";
    ...
    public Mat recognizeImage(Mat mat_image){
      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i = 0; i < 10; i++) {
            float score_value = (float) Array.get(Array.get(score, 0), i);
            if (score_value > 0.5 && score_value > highestScore) {
                highestScore = score_value;
                float class_value = (float) Array.get(Array.get(Object_class, 0), i);
                mostConfidentDetectedObjectName = labelList.get((int) class_value);
            }
        }
    ...
    public String getDetectedObjectName() {
        return mostConfidentDetectedObjectName;
    }
}
