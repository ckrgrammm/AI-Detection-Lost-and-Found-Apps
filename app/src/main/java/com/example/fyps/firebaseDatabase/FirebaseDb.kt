package com.example.fyps.firebaseDatabase

import android.util.Log
import com.example.fyps.model.*
import com.example.fyps.util.Constants.Companion.ADDRESS_COLLECTION
import com.example.fyps.util.Constants.Companion.CART_COLLECTION
import com.example.fyps.util.Constants.Companion.CATEGORIES_COLLECTION
import com.example.fyps.util.Constants.Companion.CATEGORY
import com.example.fyps.util.Constants.Companion.COLOR
import com.example.fyps.util.Constants.Companion.ID
import com.example.fyps.util.Constants.Companion.ORDER_PLACED_STATE
import com.example.fyps.util.Constants.Companion.PRICE
import com.example.fyps.util.Constants.Companion.PRODUCTS_COLLECTION
import com.example.fyps.util.Constants.Companion.QUANTITY
import com.example.fyps.util.Constants.Companion.SIZE
import com.example.fyps.util.Constants.Companion.STORES_COLLECTION
import com.example.fyps.util.Constants.Companion.TITLE
import com.example.fyps.util.Constants.Companion.USERS_COLLECTION
