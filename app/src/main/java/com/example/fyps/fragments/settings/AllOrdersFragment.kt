...
import com.example.fyps.adapters.recyclerview.AllOrdersAdapter
import com.example.fyps.databinding.FragmentAllOrdersBinding
...
class AllOrdersFragment : Fragment() {
    ...
    private fun onItemClick() {
        allOrdersAdapter.onItemClick = { material ->
            ...
            bundle.putString("partnershipID", material.partnershipsID)
